...
process.on('uncaughtException', (err) => {
    // Ignorar silenciosamente - el servidor sigue corriendo
});
process.on('unhandledRejection', () => {
    // Ignorar promesas rechazadas sin catch
});
...
const initWhatsApp = () => {
    ...
    waClient.on('ready', () => {
        ...
        waStatus = 'CONECTADO';
        waReady = true;
        console.log('✅ WhatsApp Web (NAIS Bot) conectado y listo con RemoteAuth!');
    });
