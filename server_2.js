...
❌ *RECHAZAR* — para declinar la asignación`;
            ...
            if (chatId) {
                ...
                const sessionData = { state: 'WAITING_VEHICLE_CONFIRM', ctx: { txId, vehicleId, mainApiUrl: mainApiUrl || 'https://www.naisata.com' } };
    ...
    try {
        ...
        // --- FLUJO TAREAS ---
            ...
            if (b === '1' || b === 'aceptar' || b === 'acepto' || b === 'si' || b === 'sí') {
                try {
                    let mainApiUrl = s.ctx.mainApiUrl || 'https://www.naisata.com';
                    // Normalizar dominio viejo por si la sesión se generó antes del fix
                    mainApiUrl = mainApiUrl.replace('naisa.newbox.mx', 'www.naisata.com');
