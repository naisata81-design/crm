...
// /tmp es siempre escribible en Railway (a diferencia de /app que puede ser read-only)
const WA_DATA_PATH = '/tmp';
...
const initWhatsApp = () => {
    ...
    waClient.on('disconnected', async (reason) => {
        ...
        // Auto-reconectar: destruir el cliente roto y crear uno nuevo
    ...
    waClient.on('auth_failure', async (msg) => {
        ...
        // En fallo de auth también reiniciamos con cliente nuevo
